    ...
    <div className="container w-70">
      <div className="row justify-content-center ">
        ...
        <div className="col-lg-4 col-12 p-2">
          <p className="m-3"><FontAwesomeIcon icon={faGlobe}/><small className="ml-2 color-yellow text-footer">United States
            (EN)</small></p>
          <p className="m-3"><FontAwesomeIcon icon={faPhone}/><small className="ml-2 color-yellow text-footer">+1
        ...
        <div className="col-lg-4 col-12 p-2">
          ...
          <p className="m-3"><NavLink to="/" className="text-decoration-none text-footer"><small>Become A YourCase
