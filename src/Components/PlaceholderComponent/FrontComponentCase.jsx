    ...
    <div className="container overflow-container">
      <div className="row">
        <div className="pt-3 pl-5 pt-md-5 mt-md-5 col-12 col-md-8">
          ...
          <p className="main-subtitle d-none d-md-flex">Find the attorney you need in minutes.
            Free.</p>
          <p className="main-subtitle d-flex d-md-none pt-3 pb-1 pt-md-0 pb-md-0">Find the attorney
            you
